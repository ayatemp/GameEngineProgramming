...
bool Intersect(const OBB& a,const OBB& b)
{
    ...
    //Aの方の頂点---------------------------------------------
    a_[0].x = a.mCenter.x - a.mExtents.x * a.mRotation.x / 2 ;
    a_[0].y = a.mCenter.y + a.mExtents.y * a.mRotation.y / 2 ;
    a_[0].z = a.mCenter.z - a.mExtents.z * a.mRotation.z / 2 ;
    
    a_[1].x = a.mCenter.x + a.mExtents.x * a.mRotation.x / 2 ;
    a_[1].y = a.mCenter.y + a.mExtents.y * a.mRotation.y / 2 ;
    a_[1].z = a.mCenter.z - a.mExtents.z * a.mRotation.z / 2 ;
    
    a_[2].x = a.mCenter.x + a.mExtents.x * a.mRotation.x / 2 ;
    a_[2].y = a.mCenter.y + a.mExtents.y * a.mRotation.y / 2 ;
    a_[2].z = a.mCenter.z + a.mExtents.z * a.mRotation.z / 2 ;
    
    a_[3].x = a.mCenter.x - a.mExtents.x * a.mRotation.x / 2 ;
    a_[3].y = a.mCenter.y + a.mExtents.y * a.mRotation.y / 2 ;
    a_[3].z = a.mCenter.z + a.mExtents.z * a.mRotation.z / 2 ;
    
    a_[4].x = a.mCenter.x - a.mExtents.x * a.mRotation.x / 2 ;
    a_[4].y = a.mCenter.y - a.mExtents.y * a.mRotation.y / 2 ;
    a_[4].z = a.mCenter.z - a.mExtents.z * a.mRotation.z / 2 ;
    
    a_[5].x = a.mCenter.x + a.mExtents.x * a.mRotation.x / 2 ;
    a_[5].y = a.mCenter.y - a.mExtents.y * a.mRotation.y / 2 ;
    a_[5].z = a.mCenter.z - a.mExtents.z * a.mRotation.z / 2 ;
    
    a_[6].x = a.mCenter.x + a.mExtents.x * a.mRotation.x / 2 ;
    a_[6].y = a.mCenter.y - a.mExtents.y * a.mRotation.y / 2 ;
    a_[6].z = a.mCenter.z + a.mExtents.z * a.mRotation.z / 2 ;
    
    a_[7].x = a.mCenter.x - a.mExtents.x * a.mRotation.x / 2 ;
    a_[7].y = a.mCenter.y - a.mExtents.y * a.mRotation.y / 2 ;
    a_[7].z = a.mCenter.z + a.mExtents.z * a.mRotation.z / 2 ;
    //^-----------------------------------------------------
    
    //Bの方の頂点---------------------------------------------
    b_[0].x = b.mCenter.x - b.mExtents.x * b.mRotation.x / 2 ;
    b_[0].y = b.mCenter.y + b.mExtents.y * b.mRotation.y / 2 ;
    b_[0].z = b.mCenter.z - b.mExtents.z * b.mRotation.z / 2 ;
    
    b_[1].x = b.mCenter.x + b.mExtents.x * b.mRotation.x / 2 ;
    b_[1].y = b.mCenter.y + b.mExtents.y * b.mRotation.y / 2 ;
    b_[1].z = b.mCenter.z - b.mExtents.z * b.mRotation.z / 2 ;
    
    b_[2].x = b.mCenter.x + b.mExtents.x * b.mRotation.x / 2 ;
    b_[2].y = b.mCenter.y + b.mExtents.y * b.mRotation.y / 2 ;
    b_[2].z = b.mCenter.z + b.mExtents.z * b.mRotation.z / 2 ;
    
    b_[3].x = b.mCenter.x - b.mExtents.x * b.mRotation.x / 2 ;
    b_[3].y = b.mCenter.y + b.mExtents.y * b.mRotation.y / 2 ;
    b_[3].z = b.mCenter.z + b.mExtents.z * b.mRotation.z / 2 ;
    
    b_[4].x = b.mCenter.x - b.mExtents.x * b.mRotation.x / 2 ;
    b_[4].y = b.mCenter.y - b.mExtents.y * b.mRotation.y / 2 ;
    b_[4].z = b.mCenter.z - b.mExtents.z * b.mRotation.z / 2 ;
    
    b_[5].x = b.mCenter.x + b.mExtents.x * b.mRotation.x / 2 ;
    b_[5].y = b.mCenter.y - b.mExtents.y * b.mRotation.y / 2 ;
    b_[5].z = b.mCenter.z - b.mExtents.z * b.mRotation.z / 2 ;
    
    b_[6].x = b.mCenter.x + b.mExtents.x * b.mRotation.x / 2 ;
    b_[6].y = b.mCenter.y - b.mExtents.y * b.mRotation.y / 2 ;
    b_[6].z = b.mCenter.z + b.mExtents.z * b.mRotation.z / 2 ;
    
    b_[7].x = b.mCenter.x - b.mExtents.x * b.mRotation.x / 2 ;
    b_[7].y = b.mCenter.y - b.mExtents.y * b.mRotation.y / 2 ;
    b_[7].z = b.mCenter.z + b.mExtents.z * b.mRotation.z / 2 ;
    //------------------------------------------------------
    //-----------------------------------------------------------------/////////

    //軸の設定----------------------------------------------------------/////////
    Vector3 Ae1, Ae2, Ae3;          //x,y,zの順番に並行（相対座標）
    Vector3 Be1, Be2, Be3;          //x,y,zの順番に並行（相対座標）
    Vector3 SplitAxis[15];
    
    Vector3 tmp;    //一時変数
    
    tmp =( a_[1] + a_[6] ) / 2;
    tmp = tmp - a.mCenter;
    SplitAxis[0] = tmp / tmp.Length();
    
    tmp =( a_[0] + a_[2] ) / 2;
    tmp = tmp - a.mCenter;
    SplitAxis[1] = tmp / tmp.Length();
    
    tmp =( a_[3] + a_[6] ) / 2;
    tmp = tmp - a.mCenter;
    SplitAxis[2] = tmp / tmp.Length();
    
    tmp =( b_[1] + b_[6] ) / 2;
    tmp = tmp - b.mCenter;
    SplitAxis[3] = tmp / tmp.Length();
    
    tmp =( b_[0] + b_[2] ) / 2;
    tmp = tmp - b.mCenter;
    SplitAxis[4] = tmp / tmp.Length();
    
    tmp =( b_[3] + b_[6] ) / 2;
    tmp = tmp - b.mCenter;
    SplitAxis[5] = tmp / tmp.Length();
    //----------------------------------------------------------------/////////
    
    double rA, rAmax = 0.0, rAmin = 1000000.0;
    double rB, rBmax = 0.0, rBmin = 1000000.0;
    ...
    for(int i = 0; i < 6; i++)
    {
        ...
        {
            double tmp_a;
            tmp_a  = Vector3::Dot(SplitAxis[i], a_[t]);
            if(tmp_a >= rAmax)
            {
                rAmax = tmp_a;
            }
            ...
            double tmp_b;
            tmp_b = Vector3::Dot(SplitAxis[i], b_[t]);
        }
        
        rA = rAmin + rAmax;
        rB = rBmin + rBmax;
        
        Vector3 tmp = a.mCenter + b.mCenter;
        double DistanceCenter = tmp.Length();
        
        if(rA + rB >= DistanceCenter)
        {
            return true;
        }
    }
    ...
    for(int i = 0; i < 3; i++)
    {
        for(int j = 3; j < 6; j++)
        {
            ...
            Vector3 CrossAxis;
            CrossAxis = Vector3::Cross(SplitAxis[i],SplitAxis[j]);
            for(int t = 0; t < 8; t++)
            {
                double tmp_a;
                tmp_a  = Vector3::Dot(CrossAxis, a_[t]);
                if(tmp_a >= rAmax)
                {
                    rAmax = tmp_a;
                }
                ...
                double tmp_b;
                tmp_b = Vector3::Dot(CrossAxis, b_[t]);
            }
