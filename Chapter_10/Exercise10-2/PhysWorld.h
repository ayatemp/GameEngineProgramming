...
private:
    ...
    //課題１０−２
    std::vector<class BoxComponent*> mBoxes_x;
    std::vector<class BoxComponent*> mBoxes_y;
    std::vector<class BoxComponent*> mBoxes_z;
    
    std::unordered_map<BoxComponent*, BoxComponent*> test_x;
    std::unordered_map<BoxComponent*, BoxComponent*> test_y;
    std::unordered_map<BoxComponent*, BoxComponent*> test_z;
};
