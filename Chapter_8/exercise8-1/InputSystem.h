...
struct InputState
{
    ...
    //課題８−1
    //複数のゲームコントローラーを使えるように配列を作る
    //std::unordered_map<int, ControllerState> ControllerAllay;
    ControllerState ControllerAllay[4];
...
private:
    ...
    //課題８−１
    std::vector<SDL_GameController*> mControllerAllay;
};
