...
//課題１３−２
void Renderer::AddSpotLight(SpotLightComponent* slight)
{
    mSpotLights.emplace_back(slight);
}

void Renderer::RemoveSpotLight(SpotLightComponent* slight)
{
    auto iter = std::find(mSpotLights.begin(), mSpotLights.end(), slight);
...
void Renderer::DrawFromGBuffer()
{
    ...
    for (SpotLightComponent* s : mSpotLights)
    {
        s->Draw(mGSpotLightShader, mSpotLightMesh);
    }
}
