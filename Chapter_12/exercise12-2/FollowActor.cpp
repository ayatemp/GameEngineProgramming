	...
	,mMoving(false)
{
    ...
    mMeshComp->SetAnimation("CatActionIdle", game->GetAnimation("Assets/CatActionIdle.gpanim"));
    mMeshComp->SetAnimation("CatRunSprint", game->GetAnimation("Assets/CatRunSprint.gpanim"));
