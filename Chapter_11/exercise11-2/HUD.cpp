...
void HUD::Draw(Shader* shader)
{
	...
	{
        if(targetPos_z[i] > playerPos_z )  mBlipTex = r->GetTexture("Assets/BlipUp.png");
        else if(targetPos_z[i] <= playerPos_z ) mBlipTex = r->GetTexture("Assets/BlipDown.png");
...
void HUD::UpdateRadar(float deltaTime)
{
	...
	for (auto tc : mTargetComps)
	{
        ...
        targetPos_z.emplace_back(targetPos.z);
