...
public:
    ...
    void AddArrowComponent(class ArrowComponent* ac);
    void RemoveArrowComponent(class ArrowComponent* ac);
    
    float GetArrowAngle(){ return mArrowAngle; }
protected:
    ...
    std::vector<class ArrowComponent*> mArrowComps;
    std::vector<Vector2> mABlips;
    
    Vector2 mArrowDirection;
    float mArrowAngle;
};
